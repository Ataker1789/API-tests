...
7. Создать файл .env.override в корне проекта и добавить в него свои данные:
```bash
TEST_LOGIN=your.email@example.com
```
```bash
TEST_PASSWORD=yourpassword
```
8. Проверить существует ли в testdata файл square.png
...
10. Отдельный тест можно запустить командой:
